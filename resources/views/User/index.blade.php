                ...
                <div class="banner lazy" data-bg="url(teamplate/img/banner.jpg)">
                    <div class="wrapper d-flex align-items-center justify-content-between opacity-mask"
                        ...
                        <figure class="d-none d-lg-block">
                            <img src="teamplate/img/TypoBanner.png" alt="" width="400" height="350" class="img-fluid">
                        </figure>
                        <div>
                ...
                <div class="container">
                    <div class="food-menu">
                        ...
                        <div class="container">
                            ...
                            <p class="text-center"><a href="/thuc-don" class="btn_1 outline" data-cue="zoomIn">Xem thêm thực đơn</a></p>
                        </div>
                    </div>
                </div>
                <!-- /row -->
                        ...
                        <div class="row">
                            @foreach ($posts as $post)
                                <div class="col-md-4" data-cue="slideInUp">
                                    <article class="blog">
                                        <figure>
                                            <a href="{{ 'blog/' . $post->id }}-{{ \Str::slug($post->title, '-') }}.html">
                                        ...
                                        <div class="post_info">
                                            ...
                                            <h2><a href="{{ 'blog/' . $post->id }}-{{ \Str::slug($post->title, '-') }}.html">{{ $post->title }}</a></h2>
